...
P(A|E) = Probability of having a set of identical twins knowing the twins are both boys       
P(A) = Probability of having a set of identical twins  
P(B) = Probability of having a set of fraternal twins     
P(E) = Probability of having a fraternal or identical set of twin boys     
      
P(E|A) = 1/2     
*The probability a set of twins are either frateral or identical boys knowing only that the twins are identical is 1/2.  The identical twins had 50% chance of being girls.*        
P(A) = 1/300        
     
P(E|B) = 1/4        
*The probability of having either fraternal or identical twin boys knowing that the twins will be fraternal is 1/4.  The possibilities are GG, BG, GB, BB so BB is 1/4.*      
    
P(B) = 1/125  
     
P(A|E) = (1/2 * 1/300)/{(1/2 * 1/300) + (1/4) * (1/125) = 0.4545     
     
There was a 45% chance Elvis was an identical twin.     
...
>> 
Frequentist statistics only draws conclusions about probability from sampling.    
Bayesian statistics updates a prior distribution in light of new data to get a new probability distribution called the posterior distribution. 
